export default function () {
  ...
  function getTailOfURI(uri) {
   ...
   function checkToken() {
     ...
     const retrievedTime = getCookie('retrieved');
     if (currentTime - retrievedTime > 3600000) {
       fetch('http://localhost:8080/auth/refresh?refresh_token=' + getCookie('refresh_token'),
